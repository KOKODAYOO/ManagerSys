...
public class DynamicsPicture implements Serializable {
    private Integer id;
    ...
    public DynamicsPicture withId(Integer id) {
        this.setId(id);
        return this;
    }
    ...
    public DynamicsPicture withContent_url(String content_url) {
    ...
    public boolean equals(Object that) {
        ...
        DynamicsPicture other = (DynamicsPicture) that;
