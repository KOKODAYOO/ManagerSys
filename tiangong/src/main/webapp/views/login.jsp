...
<body class="hold-transition login-page" style="background:url(${APP_PATH }/images/bg.png) no-repeat center;
  ...
  <div class="login-box-body">
    ...
    <form action="../admin/login" method="get">
      ...
      <div class="social-auth-links text-center">
      	<input class="btn btn-block btn-social btn-facebook btn-flat" type="submit" value="登录" style="text-align:center ">
      </div>      
    </form>
